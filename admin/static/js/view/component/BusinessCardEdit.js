...
class BusinessCardFrom extends React.Component{
    constructor(props){
        super(props);
        this.state = {
            businessCardInfo: {
            ...
            <div>
                <Form layout='horizontal'>
                    ...
                    <Form.Item label="GitHub链接" {...formItemLayout}>
                        {/* {getFieldDecorator('git_href', {  })(
                            <Input placeholder="" />,
                        )} */}
                        {getFieldDecorator('git_href', {
                                    initialValue: businessCardInfo.git_href,
...
const BusinessCardEdit = Form.create({ name: 'normal_Editform' })(BusinessCardFrom);
